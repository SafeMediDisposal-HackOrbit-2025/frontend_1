...
export default function AdminAuth() {
  ...
  const handleGoogleLogin = () => {
    // Navigate to a Google-specific admin auth flow
    navigate('/admin/login?method=google');
  };

  const handlePhoneLogin = () => {
    // Navigate to phone authentication for admin
    navigate('/admin/phone-auth');
  };
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="pt-12 px-6 pb-8">
        <div className="flex justify-center mb-8">
          <div className="animate-[scaleIn_0.6s_ease-out_forwards]">
