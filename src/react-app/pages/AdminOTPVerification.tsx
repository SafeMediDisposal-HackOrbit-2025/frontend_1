...
export default function AdminOTPVerification() {
  ...
  const email = location.state?.email || 'admin*@hospital.com';
    ...
    <div className="min-h-screen bg-[#F5F9F9] px-6 py-8">
      <div className="max-w-sm mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <Link to="/admin/reset-password" className="p-2 -ml-2">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-500">
            We have sent the OTP code to your admin email {maskedEmail}
          </p>
        </div>
